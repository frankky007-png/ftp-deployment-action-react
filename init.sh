...
while true; do
  ...
  lftp \
    ...
    "${INPUT_SERVER}" \
    -e "rm -r assets; rm -f index.html logo_web.png logo_web_2.png logo_web_3.png robots.txt vite.svg ${FTP_SETTINGS} ${MIRROR_COMMAND} ${INPUT_LOCAL_DIR} ${INPUT_REMOTE_DIR};" &&
    SUCCESS="true"
